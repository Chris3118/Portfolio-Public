...
export default function ContactSection({ isDarkMode, variants, cardClasses }: ContactSectionProps) {
    const contactInfo = {
        whatsapp: "+593979026164",
        email: "davilachristian659@outlook.com",
        linkedin: "https://linkedin.com/in/christian-dávila-3a76b4214",
        github: "https://github.com/Chris3118"
    };
    ...
    const handleEmail = () => {
        ...
        const body = encodeURIComponent("Hola! Me interesa contactarte para discutir un proyecto.");
    ...
    const buttonClasses = isDarkMode
        ...
        : "bg-white/90 hover:bg-white border-blue-200 text-slate-800";
        ...
        >
            ...
            <div className={`backdrop-blur-sm rounded-xl p-8 shadow-xl ${cardClasses}`}>
                <div className="text-center mb-8">
                    <p className={`text-lg mb-6 ${isDarkMode ? 'text-slate-300' : 'text-slate-700'}`}>
                        ¡Conectemos! Elige tu plataforma preferida para contactarme
                    </p>
                </div>
